...
class StageToolRuntime:
    ...
    def list_directory(self, relative_path: Optional[str], pattern: Optional[str], limit: int) -> str:
        ...
        raise NotImplementedError("TODO(student): implement list_files path, glob, limit, and policy handling")
    ...
    def grep_repo(self, pattern: str, relative_path: Optional[str], glob: Optional[str], limit: int) -> str:
        ...
        raise NotImplementedError("TODO(student): implement grep_repo regex search, policy checks, and large-file skips")
